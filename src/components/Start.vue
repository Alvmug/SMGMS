<template>
  ...
  <div class="cards">
    ...
    <router-link to="/Teachers" class="router"
      ><div class="card2">
        <FontAwesomeIcon :icon="faChalkboardTeacher" style="font-size: 40px" />
        <h1>Teacher</h1>
      </div>
    </router-link>
    <router-link to="/Admin" class="router"
      ><div class="card3">
        <FontAwesomeIcon :icon="faMicrochip" style="font-size: 40px" />
        <h1>Admin</h1>
      </div></router-link
    >
  </div>
